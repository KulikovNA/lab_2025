...
def generate_launch_description():
  ...
  start_robot_state_publisher_cmd1 = Node(
    ...
    parameters=[{'robot_description1': Command(['xacro ', urdf_model])}])
    
      # Subscribe to the joint states of the robot, and publish the 3D pose of each link.    
  start_robot_state_publisher_cmd2 = Node(
    package='robot_state_publisher',
    executable='robot_state_publisher',
    parameters=[{'robot_description2': Command(['xacro ', urdf_model])}])
    


  # Publish the joint states of the robot
  start_joint_state_publisher_cmd1 = Node(
    ...
    condition=UnlessCondition(gui))
      ...
      # Publish the joint states of the robot
  start_joint_state_publisher_cmd2 = Node(
    package='joint_state_publisher',
    executable='joint_state_publisher',
    name='joint_state_publisher2',
    condition=UnlessCondition(gui))
  ...
  ld.add_action(start_joint_state_publisher_cmd1)
  ld.add_action(start_joint_state_publisher_cmd2)
